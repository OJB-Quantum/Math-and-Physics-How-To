...
A repository of publicly-accessible resources for learning & self-teaching mathematics & physics up to the graduate level. Formed and written by Onri Jay Benally, an Indigenous American Quantum Engineer and PhD candidate.
...
| Think of fractions in terms of ratios by default | Viewing values as ratios can simplify problem-solving & conceptual understanding. You can also think of fractions as being "<numerator>" per "<denominator>". |
| Understand the difference between analytical vs. numerical approaches| Exact solutions are often associated with analytical approaches while approximation or discretized solutions are often associated with numerical appoaches. "High resolution" numerical simulation is still an approximation, but it almost uses up the full power of whatever computation machine you are using. | 
